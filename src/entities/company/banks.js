export const angolaBanks = [
  { code: "ATLANTICO", exportCode: "ATL", registryCodes: ["0055", "0054"], name: "Banco Millennium Atlântico" },
  ...
  { code: "BPC", exportCode: "BPC", registryCodes: [], name: "Banco de Poupança e Crédito" },
  { code: "SBA", exportCode: "SBA", registryCodes: ["0060"], name: "Standard Bank Angola" },
  { code: "BCI", exportCode: "BCI", registryCodes: [], name: "Banco de Comércio e Indústria" },
  { code: "BNI", exportCode: "BNI", registryCodes: [], name: "Banco de Negócios Internacional" },
  ...
  { code: "BCS", exportCode: "BCS", registryCodes: [], name: "Banco de Crédito do Sul" },
...
export function extractAngolaBankRegistryCode(iban) {
  const normalized = normalizeIban(iban);
  return /^AO\d{23}$/.test(normalized) ? normalized.slice(4, 8) : "";
}

export function inferBankFromIban(iban, banks = angolaBanks) {
